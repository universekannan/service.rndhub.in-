...
<script>
  ...
  $('#mathematics_marks_obtained').keyup(function (){
    $('#mathematics_marks').val($(this).val()); 
    $('#cut_of_mathematics').val($(this).val()); 
  });

  $('#physics_marks_obtained').keyup(function (){
    $('#physics_marks').val($(this).val());
    $('#cut_of_physics').val($(this).val() / 2); 
  });

  $('#chemistry_marks_obtained').keyup(function (){
    $('#chemistry_marks').val($(this).val()); 
    $('#cut_of_chemestry').val($(this).val() / 2); 
  });
  ...
  $('#mathematics_marks_obtained, #physics_marks_obtained, #chemistry_marks_obtained').on("paste keyup  input",
    ...
    function () {
      ...
      var total = parseInt($("#mathematics_marks_obtained").val()) + parseInt($("#physics_marks_obtained").val()) + parseInt($("#chemistry_marks_obtained").val());
