...
<table id="example2" class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $manageteachinglist->first_name }} {{ $manageteachinglist->last_name }}</a></td>
...
<!-- 2nd tap -->
        ...
        <tbody>
            @foreach($managenonteaching as $key=>$managenonteachinglist)
            <tr>
                <td>{{ $key + 1 }}</td>
               
                <td>{{ $managenonteachinglist->user_types_name }}</td>
                <td>{{ $managenonteachinglist->first_name }}</td>
                <td>{{ $managenonteachinglist->gender }}</td>
                <td>{{ $managenonteachinglist->email }}</td>
                <td>{{ $managenonteachinglist->mobile }}</td>
              
                @if($managenonteachinglist->status == 1)
                <td>Active</td>
                @else
                <td>Inactive</td>
                @endif
                <td>
                  <div class="margin">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a href="{{url('/edit/'.$managenonteachinglist->userID)}}" class="dropdown-item" > Edite Page</a>
                        </div>
                    </td>
                </div>
            </div>
