              ...
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
					...
					<div class="col-sm-6">
                   <center> <div class="nav-link">User Permission</div></center>
					</div>
					<div class="col-sm-4">
					...
					<div class="col-sm-1">
						<td>
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#userrole"><i class="fa fa-plus"> </i> Add</button>
...
<tbody>
                       @foreach($manageusers as $key=>$manageuserslist)
                        ...
                        <td>{{ $manageuserslist->last_name }}</td>
                        ...
                        @endif     
						 <td>
						 <button type="button" class="btn btn-default" data-toggle="modal" data-target="#permissions{{ $manageuserslist->user_id }}"><i class="fa fa-eye"> </i> Permissions</button>
                        </td>
