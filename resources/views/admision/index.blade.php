...
<div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
 <table id="example2" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        @foreach($manageadmision as $key=>$manageadmisonlist)
                        <tr id="arrayorder_<?php echo $manageadmisonlist->id?>">
                           <td>{{ $key + 1 }}</td>
                           <td>{{ $manageadmisonlist->candidate_name }}</td>
                           <td>{{ $manageadmisonlist->parent_guardian }}</td>
                           <td>{{ $manageadmisonlist->branch_of_study }}</td>
                           <td>{{ $manageadmisonlist->parent_occupation }}</td>
                           @if($manageadmisonlist->status == 1)
                           <td>Active</td>
                           @else
                           <td>Inactive</td>
                           @endif 
                  ...
                  <div class="margin">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a href="" class="dropdown-item"  data-toggle="modal" data-target="#edit{{ $manageadmisonlist->id }}">Edit</a>
               <!-- <a href="" class="dropdown-item"  data-toggle="modal" data-target="#assign{{ $manageadmisonlist->id }}">Assign</a> -->
                        </div>

                    </td>

                        </tr>
                        <div class="modal fade" id="edit{{ $manageadmisonlist->id }}">
                                 ...
                                 <div class="modal-content">
                                    ...
                                    <div class="col-md-6"> 
                                       <input type="hidden" class="form-control" name="id" 
                                          value="{{ $manageadmisonlist->id }}"/>

                                       <input type="text" class="form-control mb-3" name="candidate_name" 
                                          value="{{ $manageadmisonlist->candidate_name }}" placeholder="Candidate Name"/>

                                       <input type="text" class="form-control mb-3" name="parent_occupation" 
                                          value="{{ $manageadmisonlist->parent_guardian }}" placeholder="Parent Occupation"/>

                                       <input type="text" class="form-control mb-3" name="mobile_no"
                                          value="{{ $manageadmisonlist->branch_of_study }}" placeholder="Mobile No"/>

                                       <input type="text" class="form-control mb-3" name="aadhar_no"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Aadhar No"/>
                                       ...
                                       <input type="text" class="form-control mb-3" name="place_of_birth"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Place Of Birth"/>
                                       ...
                                       <input type="text" class="form-control mb-3" name="nationality"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Nationality"/>

                                       <input type="text" class="form-control mb-3" name="wheather_appeared_tancet"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Wheather Appeared TANCET"/>
                                       ...
                                       <input type="text" class="form-control mb-3" name="parent/guardian"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Parent/Guardian"/>
                                       ...
                                       <input type="text" class="form-control mb-3" name="whatapp_no"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Whatapp No"/>

                                       <input type="text" class="form-control mb-3" name="pin_code"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Pin Code"/>
                                       ...
                                       <input type="text" class="form-control mb-3" name="age"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Age"/>

                                       <input type="text" class="form-control mb-3" name="branch_of_study"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Branch Of Study"/>

                                       <select name="gender" class="form-control">
                                          
                                          <option value="">Select Gender</option>
                                          <option value="Male" <?php if($manageadmisonlist->gender == 1){ echo "selected"; }?>>Male</option>
                                          <option value="Female" <?php if($manageadmisonlist->gender == 0){ echo "selected"; }?>>Female</option>
                                       ...
                                       <input type="text" class="form-control mb-3" name="email"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Email"/>
                                          
                                       <input type="text" class="form-control mb-3" name="tancet_score"
                                          value="{{ $manageadmisonlist->parent_occupation }}" placeholder="Tancet Score"/>
