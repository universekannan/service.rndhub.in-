...
<div class="content-wrapper">
   <section class="content">
      <div class="card card-primary card-outline card-outline-tabs">
         <div class="card-header p-0 border-bottom-0">
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
               ...
               <div class="col-sm-5">
                  <center>
                     <div class="nav-link">Patients List</div>
                  </center>
               </div>
               ...
               <div class="col-sm-1" style="padding-top: calc(.5rem + 0px);">
                  <td>
                     <button type="button" class="btn btn-block btn-outline-danger btn-xs" data-toggle="modal" data-target="#addPatient"><i class="fa fa-plus"></i> Add</button>
                  </td>
               </div>
            </ul>
         </div>
      ...
      data-target="#edit{{ $manageoppatientslist->userID }}" >{{ $manageoppatientslist->patient_name }}</a></td>
                           <td>{{ $manageoppatientslist->gender }}</td>
                           <td>{{ $manageoppatientslist->age }}</td>
                           <td>{{ $manageoppatientslist->relation_name }}</td>
                           <td>{{ $manageoppatientslist->district_name }}</td>
                                          ...
                                          <div class="row">
                                             <div class="col-md-6">
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-5">
                                                      <input  value="{{ $manageoppatientslist->patient_name }}" required="required" type="text" class="form-control" name="full_name" id="full_name" maxlength="50" placeholder="Patient Full Name">
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                              ...
                                              <div class="col-sm-4 custom-file">
                                                      <select class="form-control select2bs4" name="relationship" id="relationship" style="width: 100%;" required="required">
                                                         <option value="Brother" <?php if($manageoppatientslist->relation_name == 'Brother'){ echo "selected"; }?>>Brother</option>
                                                         <option value="Brother-In-Law" <?php if($manageoppatientslist->relation_name == 'Brother-In-Law'){ echo "selected"; }?>>Brother-In-Law</option>
                                                         <option value="Daughter" <?php if($manageoppatientslist->relation_name == 'Daughter'){ echo "selected"; }?>>Daughter</option>
                                                         <option value="Father" <?php if($manageoppatientslist->relation_name == 'Father'){ echo "selected"; }?>>Father</option>
                                                         <option value="Father-In-Law" <?php if($manageoppatientslist->relation_name == 'Father-In-Law'){ echo "selected"; }?>>Father-In-Law</option>
                                                         <option value="Grand Daughter" <?php if($manageoppatientslist->relation_name == 'Grand Daughter'){ echo "selected"; }?>>Grand Daughter</option>
                                                         <option value="Grand Father" <?php if($manageoppatientslist->relation_name == 'Grand Father'){ echo "selected"; }?>>Grand Father</option>
                                                         <option value="Grand Mother" <?php if($manageoppatientslist->relation_name == 'Grand Mother'){ echo "selected"; }?>>Grand Mother</option>
                                                         <option value="Grand Son" <?php if($manageoppatientslist->relation_name == 'Grand Son'){ echo "selected"; }?>>Grand Son</option>
                                                         <option value="Husband" <?php if($manageoppatientslist->relation_name == 'Husband'){ echo "selected"; }?>>Husband</option>
                                                         <option value="Mother" <?php if($manageoppatientslist->relation_name == 'Mother'){ echo "selected"; }?>>Mother</option>
                                                         <option value="Mother-In-Law" <?php if($manageoppatientslist->relation_name == 'Mother-In-Law'){ echo "selected"; }?>>Mother-In-Law</option>
                                                         <option value="Nephew" <?php if($manageoppatientslist->relation_name == 'Nephew'){ echo "selected"; }?>>Nephew</option>
                                                         <option value="Niece" <?php if($manageoppatientslist->relation_name == 'Niece'){ echo "selected"; }?>>Niece</option>
                                                         <option value="Sister" <?php if($manageoppatientslist->relation_name == 'Sister'){ echo "selected"; }?>>Sister</option>
                                                         <option value="Sister-In-Law" <?php if($manageoppatientslist->relation_name == 'Sister-In-Law'){ echo "selected"; }?>>Sister-In-Law</option>
                                                         <option value="Son" <?php if($manageoppatientslist->relation_name == 'Son'){ echo "selected"; }?>>Son</option>
                                                         <option value="Spouse" <?php if($manageoppatientslist->relation_name == 'Spouse'){ echo "selected"; }?>>Spouse</option>
                                                         <option value="Wife" <?php if($manageoppatientslist->relation_name == 'Wife'){ echo "selected"; }?>>Wife</option>
                                                      </select>
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-8">
                                                      <select class="form-control select2bs4" name="doctor_id" id="doctor_id" style="width: 100%;" required="required">
       ...
       id="other_details" maxlength="50" placeholder="Other Details">{{ $manageoppatientslist->other_details }}</textarea>
                                          ...
                                          <div class="row">
                                             <div class="col-md-6">
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-5">
                                                      <input  value="{{ $manageoppatientslist->patient_name }}" required="required" type="text" class="form-control" name="full_name" id="full_name" disabled="disabled" maxlength="50" placeholder="Patient Full Name">
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                   <label for="date_of_birth " class="col-sm-4 col-form-label"><span style="color:red"></span>
            ...
            <select class="form-control select2bs4"
             name="gender" id="gender" style="width: 100%;" required="required" disabled="disabled">

       <option value="{{ $manageoppatientslist->gender }}">{{ $manageoppatientslist->patient_name }}</option>
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                   <label for="disease_id" class="col-sm-4 col-form-label"><span style="color:red"></span>Patient Disease</label>
                                                   <div class="col-sm-6">
     ...
     <td><a href="" data-toggle="modal" 
     data-target="#edit{{ $manageippatientslist->id }}" >{{ $manageippatientslist->patient_name }}</a>
	                       </td>
                           ...
                           <td>
                              <div class="btn-group dropdown">
                                 ...
                                 <div class="dropdown-content">
                                    <a href="" data-toggle="modal" data-target="#ipadmission{{ $manageippatientslist->userID }}">IP Admission</a>
                                    <a href="" data-toggle="modal" data-target="#appointments{{ $manageippatientslist->userID }}">Appointments</a>
                                 </div>
                              </div>
                           </td>
                        </tr>
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="form-group row">
                        <label for="dist_id" class="col-sm-4 col-form-label"><span style="color:red"></span> District & Taluk</label>
                        <div class="col-sm-4">
                           <select class="form-control select2bs4" name="district_id" id="district" style="width: 100%;" required="required">
                              <option value="">Select District Name</option>
                              @foreach($managedistrict as $key=>$managedistrictlists)
                              <option value="{{ $managedistrictlists->id }}">{{ $managedistrictlists->district_name }}</option>
                              @endforeach
                           </select>
                        </div>
                        <div class="col-sm-4">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="form-group row">
                        <label for="blood group" class="col-sm-4 col-form-label"><span style="color:red"></span>Select Doctor</label>
                        <div class="col-sm-8">
                           <select class="form-control select2bs4" name="doctor_id" id="doctor_id" style="width: 100%;" required="required">
                              <option>Select Doctor</option>
                              @foreach($managedoctor as $key=>$managedoctorlists)
                              <option value="{{ $managedoctorlists->id }}">{{ $managedoctorlists->full_name }}</option>
                              @endforeach
                           </select>
                        </div>
                     </div>
