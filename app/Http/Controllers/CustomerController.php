...
class CustomerController extends BaseController
{
    ...
    $manageCustomers = DB::table('customer')->orderBy('id','Asc')->get();
     return view("customer.index")->with('managecustomers', $manageCustomers);
 }
...
public function addCustomer(Request $request){
    ...
    return redirect('/customer')->with('success', 'Patient Added Successfully'); 
}

public function editCustomer(Request $request){
   
    $edituser = DB::table('customer')->where('id',$request->id)->update([
    ...
    return redirect('/customer')->with('success', 'Patient Updated Successfully'); 
}
