...
class StaffsController extends BaseController
{
    ...
    $manageStaffs = DB::table('staffs')->orderBy('id','Asc')->get();
     return view("staffs.index")->with('manageStaffs', $manageStaffs);
}
  ...
  public function doctorPatients(){
    ...
    $adduser = DB::table('staffs')->insertGetId([
    ...
    return redirect('/staffs')->with('success', 'Added Successfully'); 
}

     public function editStaffs(Request $request){
   
    $edituser = DB::table('staffs')->where('id',$request->id)->update([
    ...
    return redirect('/staffs')->with('success', 'Updated Successfully'); 
}
